    ...
    <div class="width1200 hidden_yh center_yh" style="margin-top: 75px;">
        <form action="${ctx}/login/toRes" method="post">
            ...
            <div class="center_yh hidden_yh" style="width: 475px;margin-bottom: 40px;">
                ...
                <input type="text" name="passWord" placeholder="建议至少使用两种字符" style="border:1px solid #c9c9c9;width: 292px;height: 42px;font-size: 16px;text-indent: 22px;" class="left_yh">
            </div>
            <div class="center_yh hidden_yh" style="width: 475px;margin-bottom: 40px;">
            ...
            <p class="font14 c_16" style="text-indent: 500px;margin-top: 30px;">
